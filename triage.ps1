...
Get-WinEvent -FilterHashtable @{ LogName='Security'; StartTime=$After; EndTime=$Before; Id='4624'} | Where-Object {$_.Message -match "Logon Type:\s+10"} | select TimeCreated,Message
